...
* [Sintaxe e Semântica](syntax_and_semantics/README.md)
   ...
   * [Tipos e métodos](syntax_and_semantics/types_and_methods.md)
       ...
       * [Classes e métodos](syntax_and_semantics/classes_and_methods.md)
           ...
           * [Variáveis de instância e inferência de tipo](syntax_and_semantics/instance_variables_type_inference.md)
           * [Sobrecarga](syntax_and_semantics/overloading.md)
           * [Valores padrão e argumentos nomeados](syntax_and_semantics/default_and_named_arguments.md)
           * [Splats e tuplas](syntax_and_semantics/splats_and_tuples.md)
           * [Restrições de tipos](syntax_and_semantics/type_restrictions.md)
           * [Tipos de retorno](syntax_and_semantics/return_types.md)
           * [Operadores](syntax_and_semantics/operators.md)
           * [Visibilidade](syntax_and_semantics/visibility.md)
